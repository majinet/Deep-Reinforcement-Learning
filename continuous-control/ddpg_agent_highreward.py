...
from ddpg_model_highreward import Actor, Critic
...
class Agent():
    ...
    def learn(self, experiences, gamma):
        ...
        Q_targets = (rewards * 3) + (gamma * Q_targets_next * (1 - dones))
